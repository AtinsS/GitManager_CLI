...
echo   %GREEN%3.%RESET% Add + Commit + Push     %GREEN%8.%RESET% Показать ветки для слияния
echo   %GREEN%4.%RESET% Меню отмены изменений   %GREEN%9.%RESET% Создать ветку
echo   %GREEN%5.%RESET% Просмотр истории        %GREEN%10.%RESET% Переключить ветку
