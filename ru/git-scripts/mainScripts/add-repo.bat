...
if /i not "!remote_url:dev.azure.com=!"=="!remote_url!" set "hosting=Azure DevOps"
if /i not "!remote_url:visualstudio.com=!"=="!remote_url!" set "hosting=Azure DevOps"
if /i not "!remote_url:codeberg=!"=="!remote_url!" set "hosting=Codeberg"
if /i not "!remote_url:gitea=!"=="!remote_url!" set "hosting=Gitea"
if /i not "!remote_url:gitee=!"=="!remote_url!" set "hosting=Gitea"
